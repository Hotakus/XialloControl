    ...
    <div class="card preset-card">
      ...
      <div class="preset-header">
        ...
        <div class="preset-controls">
          <button v-if="!state.isCreatingNewPreset" id="create-preset" title="新建方案" class="icon-button create-preset-btn"
            @click="newPreset()">
          ...
          <button v-if="!state.isCreatingNewPreset" id="delete-preset" title="删除方案" class="icon-button delete-preset-btn"
            @click="deletePreset()">
